  ...
  Future<void> _saveToLibrary() async {
    ...
    try {
      await _filamentService.saveSpoolmanFilament(
        ...
        productName: widget.filament.name,
        material: widget.filament.material,
        diameter: widget.filament.diameter,
        weight: widget.filament.weight,
        density: widget.filament.density,
        spoolWeight: widget.filament.spoolWeight,
        spoolType: widget.filament.spoolType,
        colorHex: widget.filament.colorHex,
        colorHexes: widget.filament.colorHexes,
        extruderTemp: widget.filament.extruderTemp,
        extruderTempRange: widget.filament.extruderTempRange,
        bedTemp: widget.filament.bedTemp,
        bedTempRange: widget.filament.bedTempRange,
        finish: widget.filament.finish,
        pattern: widget.filament.pattern,
        isTranslucent: widget.filament.translucent,
        isGlowInDark: widget.filament.glow,
        quantity: 1,
